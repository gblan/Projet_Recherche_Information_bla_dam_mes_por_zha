...
//		System.out.println("model");
	...
	// try {
	//
	// String[] tradCh = FileUtils.readFileToString(new
	// File("resources/ch.txt"), "UTF-8").split("\n");
	// String[] tradLink = FileUtils.readFileToString(new
	// File("resources/linksChineseFrench.txt"), "UTF-8")
	// .split("\n");
	// String[] tradFr = FileUtils.readFileToString(new
	// File("resources/fr.txt"), "UTF-8").split("\n");
	//
	...
	// suffixArray.getAllPositionsOfPhrase(search);
	//
	...
	// System.out.println("");
	// if (choix == 1) {
	// String trad = findTranslationChineseFrench(corpus.getCorpusArray()[i], 1,
	// tradCh, tradFr,
	// tradLink);
	// System.out.println(trad);
	// System.out.println(Model.getPinyin(corpus.getCorpusArray()[i]));
	// } else {
	// String trad = findTranslationChineseFrench(corpus.getCorpusArray()[i], 2,
	// tradCh, tradFr,
	// tradLink);
	// System.out.println(trad);
	...
	// System.out.println("Ligne: " + i + " Positions: " + positions);
